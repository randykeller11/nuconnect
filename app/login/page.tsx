    ...
    <div className="min-h-screen bg-gradient-to-br from-aulait to-aulait/80 flex items-center justify-center p-4">
      <Card className="w-full max-w-md shadow-2xl border-0 rounded-2xl">
        <CardHeader className="text-center pb-6">
          ...
          <CardTitle className="text-3xl font-bold text-inkwell">Welcome Back</CardTitle>
          <CardDescription className="text-lg text-lunar">Sign in to continue networking</CardDescription>
        </CardHeader>
